<%@page contentType="UTF-8" import="java.util.*, org.endorodrigo.models.*"%>
<%
...
<p><a href="<%=request.getContextPath()%>/productoss/form">crear [+]</a></p>
<%}%>
<table>
    <tr>
        <th>id</th>
    ...
    <tr>
        ...
        <td><a href="<%=request.getContextPath()%>/productoss/form?id=<%=p.getId()%>">editar</a></td>
